...
function $join(params) {
    ...
    throw new Error('$join expects an array of one/two elements of which the first must be an array and the second be an optional string');
}
